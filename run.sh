...
CUDA_VISIBLE_DEVICES=0 nohup python train.py --dataroot ./datasets/eye_cropped --mask_dataroot ./datasets/eye_cropped_mask --use_segmentation_mask_channel --mask_loss_type bce --lambda_mask 5.0 --name EYE_fund_train --label_nc 0 --no_instance --resize_or_crop resize_and_crop --loadSize 1024 --fineSize 1024 --batchSize 1  --max_dataset_size 12 --use_attention --nThreads 0 > out_fund_train.log 2>&1&


CUDA_VISIBLE_DEVICES=0 nohup python test.py --dataroot ./datasets/eye_cropped_1 --mask_dataroot ./datasets/eye_cropped_1_mask --use_segmentation_mask_channel --name EYE_fund_train_1_2k --label_nc 0 --no_instance --resize_or_crop resize_and_crop --loadSize 2048 --fineSize 2048 --batchSize 1  --use_attention --nThreads 0  --niter 50  --niter_fix_global 10 --netG local --ngf 32  > out_test_fund_1_2k.log 2>&1 &
...
CUDA_VISIBLE_DEVICES=0 nohup python test.py --dataroot ./datasets/eye_cropped --mask_dataroot ./datasets/eye_cropped_mask --use_segmentation_mask_channel --name EYE_fund_train --label_nc 0 --no_instance --resize_or_crop resize_and_crop --loadSize 1024 --fineSize 1024 --batchSize 1  --use_attention --nThreads 0 > out_test_fund.log 2>&1 &



CUDA_VISIBLE_DEVICES=0 nohup python compute_psnr.py --phases test --dataroot ./datasets/eye_cropped_1 --mask_dataroot ./datasets/eye_cropped_1_mask --use_segmentation_mask_channel --name EYE_fund_train_1_2k --label_nc 0 --no_instance --resize_or_crop resize_and_crop --loadSize 2048 --fineSize 2048 --batchSize 1 --use_attention  --niter 50  --niter_fix_global 10 --netG local --ngf 32  --nThreads 0 > out_psnr_fund_1_2k.log 2>&1 &
...
CUDA_VISIBLE_DEVICES=0 nohup python compute_psnr.py --phases test --dataroot ./datasets/eye_cropped --mask_dataroot ./datasets/eye_cropped_mask --use_segmentation_mask_channel --name EYE_fund_train --label_nc 0 --no_instance --resize_or_crop resize_and_crop --loadSize 1024 --fineSize 1024 --batchSize 1 --use_attention --nThreads 0 > out_psnr_fund.log 2>&1 &
